                    ...
                    <div class="employer-create-form">
                        ...
                        <form action="{{ route('admin.employers.update', $employer->id) }}" method="post" enctype="multipart/form-data" id="employerAdd" data-parsley-validate>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <select name="division_id" id="division_id" class="form-control" onchange="GetDistrictsList(this.value)" required>
                                            <option></option>
                                            @foreach ($divisions as $division)
                                                {{-- <option value="{{ $division->id }}" {{ $employer->division_id == $division->id ? 'selected' : '' }}>{{ $division->name }}</option> --}}
                                                <option value="{{ $division->id }}" {{ $employer->division_id == $division->id ? 'selected' : '' }} placeholder='Select Division'>{{ $division->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
...
@section('scripts')
    ...
    {{-- Dependent-list script Start for edit page --}}
    <script>
    ...
    {{-- Dependent-list script 3nd  for edit page --}}
@endsection