    ...
    <div class="col-xl-12 xl-100">
        <div class="card">
             <div class="card-header">
                <h5>Edit first step in this job</h5>
            </div> 
            <div class="card-body">
                    <div class="job-create-form">
                        ...
                        <section id="post-job-area" class="bp">
                            <div class="container">
                                ...
                                <form action="{{ route('admin.jobs.store.jobs_update', $job->id)}}" method="post" enctype="multipart/form-data" id="employerAdd" >
                                    @method('put')
                                    @csrf
                                    <div class="card-content">
                                        ...
                                        <div class="form-group row mb-20">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" id="title" value="{{ $job->title }}" name="title" class="form-control form-control-s-1 popTips" 
                                                placeholder="Write Job Title" maxlength="100" data-toggle="popover" data-trigger="focus" data-content="This will appear in job search cart so write exact words. Exact job title will increase rate of your job view. <br>* Short and precise<br>* Help the job seekers to understand<br>seniority and job function easily.<br>Bad example: Manager, Executive<br>Good example: Marketing Manager, Finance Manager , Sales Executive" data-original-title="" title="">   
                                            </div>
                                        </div> <!-- Job Title -->
                                                ...
                                                {{-- <select name="employer_id" id="employer_id"
                                                    class="form-control form-control-s-1 on-click-disabled">
                                                        ...
                                                        <option value="{{ $employer->id }}"
                                                            {{ $employer->name ? 'selected' : '' }}>{{ $employer->name }}
                                                        </option>
                                                        @endforeach
                                               </select> --}}
                                            </div>
                                        ...
                                        <div class="form-group row mb-20">
                                            ...
                                            <div class="col-md-7">
                                                <div class="row checkbox-disabled  ">
                                                    <div class="col-md-5">
                                                        <input onkeypress="return blockNonNumbers(this, event, false, false, $('#chkVacancies').prop('checked'));" onchange="return CheckNumber(this.id, $('#chkVacancies').prop('checked'));" type="text" 
                                                             value="{{ $job->no_vacancy }}"
                                                        id="txtVacancies" name="no_vacancy" maxlength="5" class="form-control form-control-s-1 popTips on-click-disabled " placeholder="Enter Vacancy Number" data-toggle="popover" data-trigger="focus" data-content="Please enter numbers only." data-original-title="" title="">
                                            ...
                                            <div class="col-md-7 jc-wrapper">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <option class="{{  $cat->name ? 'selected' : ''}}" value="{{ $cat->id }}">{{ $cat->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-7">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" autocomplete="off" class="form-control form-control-s-1 input-group date" id="txtDeadline" name="deadline" value="{{$job->deadline}}" placeholder="Select Application Deadline"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-5">
                                            ...
                                            <div class="col-md-7">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <label class="btn btn-s-1 btn-round checkbox-toggle">
                                                            <input class="hidden" autocomplete="off" id="chkCVReceiveOptionApply" name="resume_receiving_option_online" value="{{ $job->resume_receiving_option_online}}" type="checkbox">
                                                            <i class="fa fa-check toggle"></i>
                                                        ...
                                                        <div class="btn-group checkbox-toggle-group resume-receiving-tab" id="cvReceivingOption">
                                                            ...
                                                            <label class="btn btn-s-1 btn-round checkbox-toggle cvr-email" type="button" data-toggle="collapse" data-target="#collapseCvEmail">
                                                                <input type="checkbox" class="hidden" name="resume_receiving_option" id="chkCVReceiveOptionEmail" value="{{ $job->resume_receiving_option}}" autocomplete="off">
                                                            ...
                                                            <label class="btn btn-s-1 btn-round checkbox-toggle cvr-hc" type="button" data-toggle="collapse" data-target="#collapseHC">
                                                                <input type="checkbox" class="hidden" name="resume_receiving_option" id="chkCVReceiveOptionHard" value="{{ $job->resume_receiving_option}}" autocomplete="off">
                                                            ...
                                                            <label class="btn btn-s-1 btn-round checkbox-toggle cvr-wi" type="button" data-toggle="collapse" data-target="#collapseWI">
                                                                <input type="checkbox" class="hidden" name="resume_receiving_option" id="chkCVReceiveOptionWalk" value="{{ $job->resume_receiving_option}}" autocomplete="off">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-0">
                                                            <div class="collapse " id="collapseCvEmail" aria-expanded="false">
                                                                ...
                                                                <input type="email" class="form-control form-control-s-1" name="AppliedEmail" id="AppliedEmail" 
                                                                    value="@if (($job->resume_receiving_option) > 0 && ($job->resume_receiving_option) < 2) 
                                                                            {{$job->resume_receiving_option_description}}
                                                                             @endif"
                                                                 maxlength="60" placeholder="Write Email Address">
                                                                {{-- 
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-0">
                                                            ...
                                                            <div class="collapse " id="collapseWI" aria-expanded="false">
                                                                ...
                                                                <textarea name="textWalkingInterview" maxlength="4000" id="txtWalkingInterview" rows="6" class="form-control form-control-s-1 popTips" placeholder="Write Information for Walk in Interview" data-toggle="popover" data-trigger="focus" data-content="Please write precisely Interview date, address and documents to bring at interview place or others instructions." data-original-title="" title="">
                                                                    @if (($job->resume_receiving_option) == 3) 
                                                                        {{$job->resume_receiving_option_description}} 
                                                                    @endif
                                                                </textarea> 
                                                            </div>
                                        ...
                                        <div class="card-footer">
                                            <div class="float-right">
                                                ...
                                                <button href="#" type="submit" class="btn btn-success btn-lg jp1stDrftCont" actionval="0" id="HContinue">Save & Continue&nbsp;
